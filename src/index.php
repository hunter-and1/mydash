  ...
  <div class="d-flex flex-row flex-column-fluid wrapper">
    ...
    <aside class="main-sidebar-secondary p-4" style="">
      <div class="flex-shrink-0">
        <a href="/" class="menu-link menu-link-primary align-items-center active">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
          ...
          <div class="d-flex align-items-center flex-wrap">
            ...
            <div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="top" data-original-title="Quick actions">
              <a href="#" class="btn btn-bg-white btn-text-dark-50 mr-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <!--begin::Dropdown-->
            <div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="top" data-original-title="Quick actions">
              <a href="#" class="btn btn-icon-text btn-primary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="svg-icon svg-icon-md">
